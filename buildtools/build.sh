...
# 
# echo "FETCH BINUTILS"
# #wget $WFLAGS http://mirror.bjtu.edu.cn/gnu/binutils/binutils-${BINUTILS_VER}.tar.gz 
# tar -xf binutils-${BINUTILS_VER}.tar.gz
# 
# echo "FETCH GCC"
# #wget $WFLAGS http://mirror.bjtu.edu.cn/gnu/gcc/gcc-${GCC_VER}/gcc-core-${GCC_VER}.tar.gz
# tar -xf gcc-core-${GCC_VER}.tar.gz
# #wget $WFLAGS http://mirror.bjtu.edu.cn/gnu/gcc/gcc-${GCC_VER}/gcc-g++-${GCC_VER}.tar.gz
# tar -xf gcc-g++-${GCC_VER}.tar.gz
# #wget $WFLAGS http://mirror.bjtu.edu.cn/gnu/gcc/gcc-${GCC_VER}/gcc-fortran-${GCC_VER}.tar.gz
# tar -xf gcc-fortran-${GCC_VER}.tar.gz
# 
# echo "FETCH GMP"
# #wget $WFLAGS http://mirror.bjtu.edu.cn/gnu/gmp/gmp-${GMP_VER}.tar.gz
# tar -xf gmp-${GMP_VER}.tar.gz
# 
# echo "FETCH MPFR"
# #wget $WFLAGS http://mirror.bjtu.edu.cn/gnu/mpfr/mpfr-${MPFR_VER}.tar.gz
...
cp ../newlib-files/orzos-syscalls.c newlib-${NEWLIB_VER}/newlib/libc/sys/${OSNAME}/syscalls.c
