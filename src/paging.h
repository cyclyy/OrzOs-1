...
*/
#define PADDR_TO_VADDR(x) ((x) ? ((u64int)(x) + HEAP_START_ADDR) : 0)
#define VADDR_TO_PADDR(x) ((x) ? ((((u64int)x)>=CODE_LOAD_ADDR)?(((u64int)x)-CODE_LOAD_ADDR):(((u64int)x)-HEAP_START_ADDR)) : 0)
