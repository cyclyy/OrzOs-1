...
DEFN_SYSCALL_5(OzSend, 6, s64int, char *, u64int, char *, u64int);
DEFN_SYSCALL_3(OzPost, 7, s64int, char *, u64int);
DEFN_SYSCALL_3(OzReceive, 8, s64int, char *, u64int);
DEFN_SYSCALL_3(OzReply, 9, s64int, char *, u64int);
...
DEFN_SYSCALL_4(OzRead, 14, s64int, u64int, u64int, char *);
